...
from bpycad.blender_util import blender_mesh, new_mesh_obj
from bpycad.cad import Mesh, MeshPoint, Point, Transform
...
class Keyboard:
    ...
    def _left_wall_inner_corner(self) -> WallColumn:
        ...
        ic.out2 = self.mesh.add_point(
            Point(ic.out3.x, ic.out3.y, ic.out1.z + 2.0)
        )
    ...
    def apply_bevels(self, obj: bpy.types.Object) -> None:
        self._beveler.apply_bevels(obj)
