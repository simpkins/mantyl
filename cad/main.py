...
def gen_screw_hole(kbd: oukey.Keyboard) -> bpy.types.Object:
...
def add_screw_hole(
    kbd: oukey.Keyboard, kbd_obj: bpy.types.Object, x: float, z: float
) -> None:
...
def add_screw_holes(kbd: oukey.Keyboard, kbd_obj: bpy.types.Object) -> None:
    x_spacing = 40
